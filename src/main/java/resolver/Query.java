...
public class Query implements GraphQLRootResolver {
    ...
    public Query(NamespaceRepository namespaceRepository, DataElementRepository dataElementRepository, SlotRepository slotRepository, ValueDomainRepository valueDomainRepository) {
    ...
    public List<SlotDTO> slots(String key,DataFetchingEnvironment env){return slotRepository.getSlots(key);}
